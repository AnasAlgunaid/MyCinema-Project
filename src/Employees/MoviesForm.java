 ...
 * @author anasm
 */
public class MoviesForm extends javax.swing.JInternalFrame {
...
//    protected static ResultSet showsResultSet;
    ...
    public static void refreshTable(){
        String allMoviesQuery = "SELECT Movie_ID, Movie_Name AS `Movie Name`, Lang_Name AS Language, Runtime, Age_Rating AS `Age Rating` FROM Movies INNER JOIN Languages ON Movies.Language = Languages.Lang_ID ";
        
        // Check for the order combobox 
        if(orderComboBox.getSelectedItem() == "ID: Ascending"){
            allMoviesQuery = allMoviesQuery + " ORDER BY Movie_ID ASC";
        }
        else if(orderComboBox.getSelectedItem() == "ID: Descending"){
            allMoviesQuery = allMoviesQuery + " ORDER BY Movie_ID DESC";
        }
        else if(orderComboBox.getSelectedItem() == "Movie: A-Z"){
            allMoviesQuery = allMoviesQuery + " ORDER BY Movie_Name ASC";
        }else if(orderComboBox.getSelectedItem() == "Movie:Z-A"){
            allMoviesQuery = allMoviesQuery + " ORDER BY Movie_Name DESC";
        }else if(orderComboBox.getSelectedItem() == "Runtime: Ascending"){
            allMoviesQuery = allMoviesQuery + " ORDER BY Runtime ASC";
        }else if(orderComboBox.getSelectedItem() == "Runtime: Descending"){
            allMoviesQuery = allMoviesQuery + " ORDER BY Runtime DESC";
        }   

        try(
                    Statement selectAllMovies = EmployeeSystem.connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                    ResultSet moviesResultSet = selectAllMovies.executeQuery(allMoviesQuery);
                ){

            moviesTable.setModel(DbUtils.resultSetToTableModel(moviesResultSet));
            
            // Set the number of rows in the records label
            int numOfRows = moviesTable.getRowCount();
    ...
    private void initComponents() {
        ...
        moviesTable.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        moviesTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Movie_ID", "Movie_Name", "Language", "Runtime", "Age_Rating"
            }
        ) {
        ...
        moviesTable.setFocusable(false);
        ...
        searchComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Movie_ID", "Movie_Name" }));
        ...
        jLabel3.setText("<html>Movies Management</html>");
        ...
        orderComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID: Ascending", "ID: Descending", "Movie: A-Z", "Movie:Z-A", "Runtime: Ascending", "Runtime: Descending" }));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        NewAndUpdateMovie newAndUpdateMovie = new NewAndUpdateMovie(null, true);
        newAndUpdateMovie.setVisible(true);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if(selectedRow >=0){
            ...
            if(confirm == JOptionPane.YES_OPTION){
                ...
                final String DELETE_QUERY = "DELETE FROM Movies WHERE Movie_ID = ?";

                // Get the selected movie id from the table
                int selectedMovieID = (Integer) moviesTable.getModel().getValueAt(selectedRow, 0);
                try(PreparedStatement deleteStatement = EmployeeSystem.connection.prepareStatement(DELETE_QUERY)){
                    deleteStatement.setInt(1, selectedMovieID);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        int selectedRow = moviesTable.getSelectedRow();
        if(selectedRow >= 0){
            // Get the selected movie number from the table
            int selectedMovieNumber = (Integer) moviesTable.getModel().getValueAt(selectedRow, 0);
            
            NewAndUpdateMovie newAndUpdateMovie = new NewAndUpdateMovie(null, true);
            newAndUpdateMovie.setSelectedMovieID(selectedMovieNumber);
            newAndUpdateMovie.setVisible(true);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        String searchQuery = "SELECT Movie_ID, Movie_Name AS `Movie Name`, Lang_Name AS Language, Runtime, Age_Rating AS `Age Rating` FROM Movies INNER JOIN Languages ON Movies.Language = Languages.Lang_ID ";
        
        // Search by movieID or Movie_Name
        if(searchComboBox.getSelectedItem() == "Movie_ID"){
            try{
                int showID = Integer.parseInt(searchTextField.getText());
                searchQuery = searchQuery + "AND Movie_ID = " + searchTextField.getText();
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(null, "Movie ID must be a number, Please enter a valid ID", "Invalid Movie ID", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
        }else if(searchComboBox.getSelectedItem() == "Movie_Name"){
            searchQuery = searchQuery + "AND Movie_Name LIKE \'" + searchTextField.getText() +"%\'";
        }

        // Check for the order combobox 
        if(orderComboBox.getSelectedItem() == "ID: Ascending"){
            searchQuery = searchQuery + " ORDER BY Movie_ID ASC";
        }
        else if(orderComboBox.getSelectedItem() == "ID: Descending"){
            searchQuery = searchQuery + " ORDER BY Movie_ID DESC";
        }
        else if(orderComboBox.getSelectedItem() == "Movie: A-Z"){
            searchQuery = searchQuery + " ORDER BY Movie_Name ASC";
        }else if(orderComboBox.getSelectedItem() == "Movie:Z-A"){
            searchQuery = searchQuery + " ORDER BY Movie_Name DESC";
        }else if(orderComboBox.getSelectedItem() == "Runtime: Ascending"){
            searchQuery = searchQuery + " ORDER BY Runtime ASC";
        }else if(orderComboBox.getSelectedItem() == "Runtime: Descending"){
            searchQuery = searchQuery + " ORDER BY Runtime DESC";
        }        
        ...
        {
            // Refresh the table
            moviesTable.setModel(DbUtils.resultSetToTableModel(searchResultSet));
    ...
    protected static javax.swing.JTable moviesTable;
