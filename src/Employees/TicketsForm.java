 ...
 * @author anasm
 */
public class TicketsForm extends javax.swing.JInternalFrame {
    
    public static void refreshTable(){
        String allTicketsQuery = "SELECT Ticket_ID, Customer, Show_ID, Movie_Name, Theater, Start_Time, End_Time FROM TicketsInfo ";
        
        // Check for the order combobox 
        if(orderComboBox.getSelectedItem() == "Ticket ID: Ascending"){
            allTicketsQuery = allTicketsQuery + " ORDER BY Ticket_ID ASC";
        }
        else if(orderComboBox.getSelectedItem() == "Ticket ID: Descending"){
            allTicketsQuery = allTicketsQuery + " ORDER BY Ticket_ID DESC";
        }
        else if(orderComboBox.getSelectedItem() == "Show ID: Ascending"){
            allTicketsQuery = allTicketsQuery + " ORDER BY Show_ID ASC";
        }else if(orderComboBox.getSelectedItem() == "Show ID: Descending"){
            allTicketsQuery = allTicketsQuery + " ORDER BY Show_ID DESC";
        }else if(orderComboBox.getSelectedItem() == "The nearest"){
            allTicketsQuery = allTicketsQuery + " ORDER BY Start_Time ASC";
        }

        try(
                    Statement selectAllTickets = EmployeeSystem.connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    ...
    private void initComponents() {
        ...
        ticketsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Ticket_ID", "Customer", "Show_ID", "Movie_Name", "Theater", "Start_Time", "End_Time"
            }
        ) {
        ...
        searchComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ticket ID", "Movie name", "Customer" }));
        ...
        jLabel3.setText("<html>Tickets Management</html>");
        ...
        orderComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ticket ID: Ascending", "Ticket ID: Descending", "Show ID: Ascending", "Show ID: Descending", "The nearest" }));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        NewAndUpdateTicket newAndUpdateTicket = new NewAndUpdateTicket(null, true);
        newAndUpdateTicket.setVisible(true);
        ...
        if(selectedRow >=0){
            ...
            if(confirm == JOptionPane.YES_OPTION){
                ...
                try(PreparedStatement deleteStatement = EmployeeSystem.connection.prepareStatement(DELETE_QUERY);
                        PreparedStatement updateStatement = EmployeeSystem.connection.prepareStatement(UPDATE_AFTER_DELETE);)
                {
                    // Set the values
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        }else if(searchComboBox.getSelectedItem() == "Customer"){
            searchQuery = searchQuery + " Customer LIKE \'" + searchTextField.getText() +"%\' ";
        }
