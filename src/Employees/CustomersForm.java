...
public class CustomersForm extends javax.swing.JInternalFrame {
    ...
    public static void refreshTable(){
        String allCustomersQuery = "SELECT Username, Full_Name AS `Full Name`, DoB AS `Date of Birth` FROM CustomersInfo ";
        
        // Check for the order combobox 
        if(orderComboBox.getSelectedItem() == "Username: A-Z"){
            allCustomersQuery = allCustomersQuery + " ORDER BY Username ASC";
        }
        else if(orderComboBox.getSelectedItem() == "Username: Z-A"){
            allCustomersQuery = allCustomersQuery + " ORDER BY Username DESC";
        }
        else if(orderComboBox.getSelectedItem() == "Full Name: A-Z"){
            allCustomersQuery = allCustomersQuery + " ORDER BY Full_Name ASC";
        }else if(orderComboBox.getSelectedItem() == "Full Name: Z-A"){
            allCustomersQuery = allCustomersQuery + " ORDER BY Full_Name DESC";
        }

        try(
                    Statement selectAllCustomers = EmployeeSystem.connection.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                    ResultSet customersResultSet = selectAllCustomers.executeQuery(allCustomersQuery);
                ){

            customersTable.setModel(DbUtils.resultSetToTableModel(customersResultSet));
            
            // Set the number of rows in the records label
            int numOfRows = customersTable.getRowCount();
    ...
    private void initComponents() {
        ...
        customersTable.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        customersTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Username", "Full Name", "Date of Birth"
            }
        ) {
        ...
        searchComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Username", "Full Name" }));
        ...
        jLabel3.setText("<html>Customers Management</html>");
        ...
        orderComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Username: A-Z", "Username: Z-A", "Full Name: A-Z", "Full Name: Z-A" }));
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        NewAndUpdateCustomer newAndUpdateCustomer = new NewAndUpdateCustomer(null, true);
        newAndUpdateCustomer.setVisible(true);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if(selectedRow >=0){
            ...
            if(confirm == JOptionPane.YES_OPTION){
                ...
                final String DELETE_QUERY = "DELETE FROM Customers WHERE Username = ?";

            // Get the selected customer user from the table
            String selectedCustomerUser = (String) customersTable.getModel().getValueAt(selectedRow, 0);
            
                try(PreparedStatement deleteStatement = EmployeeSystem.connection.prepareStatement(DELETE_QUERY)){
                    deleteStatement.setString(1, selectedCustomerUser);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        if(selectedRow >= 0){
            ...
            NewAndUpdateCustomer newAndUpdateCustomer = new NewAndUpdateCustomer(null, true);
            newAndUpdateCustomer.setSelectedCustomerUser(selectedCustomerUser);
            newAndUpdateCustomer.setVisible(true);
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        String searchQuery = "SELECT Username, Full_Name AS `Full Name`, DoB AS `Date of Birth` FROM customersInfo  ";
        
        // Search by movieID or Movie_Name
        if(searchComboBox.getSelectedItem() == "Username"){
            searchQuery = searchQuery + "WHERE Username LIKE \'" + searchTextField.getText() +"%\'";
        ...
        // Check for the order combobox 
        if(orderComboBox.getSelectedItem() == "Username: A-Z"){
            searchQuery = searchQuery + " ORDER BY Username ASC";
        }
        else if(orderComboBox.getSelectedItem() == "Username: Z-A"){
            searchQuery = searchQuery + " ORDER BY Username DESC";
        }
        else if(orderComboBox.getSelectedItem() == "Full Name: A-Z"){
            searchQuery = searchQuery + " ORDER BY `Full Name` ASC";
        }else if(orderComboBox.getSelectedItem() == "Full Name: Z-A"){
            searchQuery = searchQuery + " ORDER BY `Full Name` DESC";
        }       
        ...
        {     
            // Refresh the table
            customersTable.setModel(DbUtils.resultSetToTableModel(searchResultSet));
    ...
    protected static javax.swing.JTable customersTable;
